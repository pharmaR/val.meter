...
vignette: >
  %\VignetteIndexEntry{adding_metric}
...
> to do this as rigorously as possible. The vulnerability (which has long been
> resolved!) is no indication of the package's quality. 
>
> If you have the means, `haven` (and perhaps more critically, the `ReadStat`
> library on which it depends) deserves your support for continuing to enable
> the migration to open source tools.
